...
describe("test increase unlock time", function () {
    ...
    it("stake same nft again", async function () {
        ...
        expect((await vePUL.ownerOf('1')).toLowerCase()).to.equal(tester.address.toLowerCase());
        ...
        expect((await vePUL.ownerOf('1')).toLowerCase()).to.equal(vePUL.address.toLowerCase());
    ...
    it("stake twice", async function () {
        ...
        expect(ok2).to.equal(false);
        expect((await vePUL.stakedNft(tester.address)).toString()).to.equal('1');
        expect((await vePUL.ownerOf('3')).toLowerCase()).to.equal(tester.address.toLowerCase());
    ...
    it("stake other nft", async function () {
        ...
        expect((await vePUL.ownerOf('2')).toLowerCase()).to.equal(other.address.toLowerCase());
