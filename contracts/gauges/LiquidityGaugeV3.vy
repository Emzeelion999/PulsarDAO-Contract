...
def __init__(_lp_token: address, _minter: address, _admin: address):
    ...
    self.inflation_rate = PUL20(pul_token).rate()
    self.future_epoch_time = PUL20(pul_token).future_epoch_time_write()
...
def reward_contract() -> address:
    """
    @notice Address of the reward contract providing non-PUL incentives for this gauge
