...
BURNERS = {
    LPBurner: ["0x075b1bb99792c9E1041bA13afEf80C91a1e70fB3"],  # sbtcPUL
    BTCBurner: [
...
def test_fee_distribution():
    ...
    # set LP burner to unwrap sbtcPUL -> sBTC and transfer to BTC burner
