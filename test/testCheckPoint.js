...
describe("test uniswap price oracle", function () {
    ...
    beforeEach(async function() {
        ...
        await PUL.connect(tester).approve(vePUL.address, decimalToUnDecimalStr(100000000));
    ...
    it("check point", async function () {
        ...
        const segment1 = getBiasAndSlope(PULAmount1, unlockTime1 - startTime1, MAXTIME);
        ...
        expect((await PUL.balanceOf(tester.address)).toString()).to.equal(PULBalance);
        ...
        const segment2 = getBiasAndSlope(PULAmount2, unlockTime2 - startTime2, MAXTIME);
        ...
        const segment3 = getBiasAndSlope(PULAmount3, unlockTime3 - startTime3, MAXTIME);
        // compute current point
        ...
        const segment4 = getBiasAndSlope(PULAmount4, unlockTime4 - startTime4, MAXTIME);
        ...
        const segment5 = getBiasAndSlope(PULAmount5, unlockTime5 - startTime5, MAXTIME);
        ...
        const segment6 = getBiasAndSlope(PULAmount6, unlockTime6 - startTime6, MAXTIME);
        ...
        const segment7 = getBiasAndSlope(PULAmount7, unlockTime7 - startTime7, MAXTIME);
        ...
        const segment8 = getBiasAndSlope(PULAmount8, unlockTime8 - startTime8, MAXTIME);
        ...
        const segment9 = getBiasAndSlope(PULAmount9, unlockTime9 - startTime9, MAXTIME);
        ...
        const segment10 = getBiasAndSlope(PULAmount10, unlockTime10 - startTime10, MAXTIME);
        ...
        const segment11 = getBiasAndSlope(PULAmount11, unlockTime11 - startTime11, MAXTIME);
        ...
        const segment12 = getBiasAndSlope(PULAmount12, unlockTime12 - startTime12, MAXTIME);
        ...
        const segment13 = getBiasAndSlope(PULAmount13, unlockTime13 - startTime13, MAXTIME);
        ...
        const segment14 = getBiasAndSlope(PULAmount14, unlockTime14 - startTime14, MAXTIME);
