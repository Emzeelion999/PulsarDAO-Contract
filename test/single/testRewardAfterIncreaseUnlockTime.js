...
describe("test increase unlock time", function () {
    ...
    it("increase amount", async function () {
        ...
        const reward3 = await tryIncreaseUnlockTime(vePUL, PUL, '1', tester, newEndTime);
        ...
        const expectReward3 = stringDiv(stringMul(deltaGlobalAcc3, lastVePUL2), q128);
        ...
        const deltaGlobalAcc4 = stringDiv(stringMul(stringMul(rewardPerBlock, '20'), q128), stakePULAmount);

        const expectReward4 = stringDiv(stringMul(deltaGlobalAcc4, lastVePUL3), q128);
